...
const SignIn = () => {
  ...
  const { createExistingUserSignIn, passwordReset, googleSignIn, setLoading } =
  ...
  const handleSubmit = (e) => {
    ...
    createExistingUserSignIn(email, password)
      .then((result) => {
  ...
  return (
    <div className="h-full w-full py-10 px-4">
      <Helmet>
        <title>Art Of Defensee-SignIn</title>
      </Helmet>
      <div className="flex gap-5 lg:flex-row md:flex-row flex-col items-center justify-center">
        ...
        <div className="bg-white shadow-2xl  rounded lg:w-1/3  md:w-1/2 w-full p-10">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <p className="text-sm flex justify-between mt-4 font-medium leading-none text-gray-500">
              Don't have account?
              <Link to="/signup">
                <span
                  tabIndex={0}
              ...
              <span
                ...
                className="text-sm font-medium leading-none underline text-blue-700 cursor-pointer"
              >
                Reset Password
              </span>
            </p>
